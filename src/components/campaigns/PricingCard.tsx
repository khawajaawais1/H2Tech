...
const PricingCard = ({
  ...
  const content = (
    <div className="group relative flex h-full min-w-0 flex-col rounded-[22px] bg-white p-5 sm:rounded-[26px] sm:p-8 lg:p-6 xl:p-7">
  ...
  if (tier.featured) {
    return (
      <div
        className="campaign-card-in relative h-full min-w-0 rounded-[24px] bg-gradient-to-br from-[#C11212] via-[#FF6B6B] to-[#C11212] p-[2px] shadow-[0_22px_55px_rgba(193,18,18,0.24)] transition-transform duration-300 hover:-translate-y-2 sm:rounded-[28px]"
  ...
  return (
    <div
      className="campaign-card-in relative h-full min-w-0 rounded-[24px] border border-black/10 shadow-[0_4px_18px_rgba(5,10,48,0.05)] transition-all duration-300 hover:-translate-y-2 hover:shadow-[0_26px_60px_rgba(5,10,48,0.12)] sm:rounded-[28px]"
      style={{ animationDelay: `${delay}ms` }}
    >
      {content}
    </div>
